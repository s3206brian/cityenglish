    ...
    <main className="max-w-4xl mx-auto px-6 py-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/admin/courses/certify"
            className="border border-purple-300 text-purple-700 text-sm font-medium px-4 py-2 rounded-xl hover:bg-purple-50 transition flex items-center gap-2"
          >
            🎓 學員認證
          </Link>
          <Link
